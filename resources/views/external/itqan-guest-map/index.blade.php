...
<head>
    ...
    <link rel="stylesheet" href="{{ request()->getBaseUrl() }}/assets/itqan-external-guest-map/guest-map.css?v=20260710-template-mobile-crop-fix">
</head>
...
<script src="{{ request()->getBaseUrl() }}/assets/itqan-external-guest-map/path-geometry.js?v=20260710-template-mobile-crop-fix"></script>
<script src="{{ request()->getBaseUrl() }}/assets/itqan-external-guest-map/guest-map.js?v=20260710-template-mobile-crop-fix"></script>
</body>
</html>
