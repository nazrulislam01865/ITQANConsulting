    ...
    <div class="digital-contact-card reveal">
      <div class="digital-contact-inner">
        <div class="digital-contact-copy">
          ...
          <h2 id="digitalContactTitle">{{ $cta['title'] }}</h2>
          <p class="digital-contact-text">{{ $cta['text'] }}</p>
        ...
        <div class="digital-contact-qr-column">
          <div class="digital-contact-qr-frame" aria-label="{{ $cta['qr_alt'] }}">
            <img src="{{ $cta['qr_image_url'] }}" alt="{{ $cta['qr_alt'] }}" loading="lazy">
          </div>
          <p class="digital-contact-qr-caption">{{ $cta['qr_caption'] }}</p>
        </div>
      </div>
    </div>
  </div>
...
<script>
  (() => {
    ...
    const requestedFileName = @json($cta['contact_file_name'] ?? 'ITQAN-Consulting-Digital-Card.vcf');
