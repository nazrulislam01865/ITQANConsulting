...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['type' => 'award', 'image' => null, 'alt' => '']));
...
foreach (array_filter((['type' => 'award', 'image' => null, 'alt' => '']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div <?php echo e($attributes->class(['credential-logo', 'uiu-logo' => $type === 'uiu'])); ?> <?php if(!$image): ?> aria-hidden="true" <?php endif; ?>>
    <?php if($image): ?>
        <img src="<?php echo e(\App\Support\StarPmAminulMedia::url($image)); ?>" alt="<?php echo e($alt); ?>">
    <?php else: ?>
    <?php switch($type):
        case ('pmp'): ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/ITQANConsulting/resources/views/components/starpmaminul/portfolio/credential-logo.blade.php ENDPATH**/ ?>