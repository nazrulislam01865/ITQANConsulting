<?php
  ...
  $defaults = config('itqan.pages.home.cta', []);
...
<div class="form-grid">
  <div class="field full">
    ...
    <div class="image-preview" style="max-width:280px;background:#08111f;padding:18px;border-radius:24px">
      <img src="<?php echo e($qrPreviewUrl); ?>" alt="Current digital contact QR code" style="width:100%;aspect-ratio:1;object-fit:contain">
    </div>
    <input type="file" name="qr_image" accept="image/jpeg,image/png,image/webp">
    <small>Upload a square PNG, JPG, or WebP image. A transparent PNG gives the closest result to the provided template.</small>
  </div>

  <div class="field"><label>Eyebrow text</label><input name="label" value="<?php echo e(old('label', $section->label)); ?>"></div>
  <div class="field full"><label>Headline</label><textarea name="title"><?php echo e(old('title', $section->title)); ?></textarea></div>
  <div class="field full"><label>Description</label><textarea name="lead"><?php echo e(old('lead', $section->lead)); ?></textarea></div>
  ...
  <div class="field"><label>Downloaded contact filename</label><input name="settings[contact_file_name]" value="<?php echo e(old('settings.contact_file_name', array_key_exists('contact_file_name', $settings) ? $settings['contact_file_name'] : ($defaults['contact_file_name'] ?? 'ITQAN-Consulting-Digital-Card.vcf'))); ?>"></div>
...
<div class="page-head" style="margin-bottom:18px">
  <div>
    ...
    <p>These fields are used to build the downloadable .vcf contact file.</p>
  </div>
</div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/ITQANConsulting/resources/views/admin/home/sections/home-cta.blade.php ENDPATH**/ ?>