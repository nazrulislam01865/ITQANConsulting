...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('vendor/itqan-guest-map-leaflet/leaflet.css')); ?>?v=1.9.4">
    <link rel="stylesheet" href="<?php echo e(asset('assets/itqan-external-guest-map/guest-map.css')); ?>?v=itqan-ext-map-2">
</head>
<body data-base-url="<?php echo e(url('/')); ?>" data-default-from="<?php echo e($from); ?>" data-default-to="<?php echo e($to); ?>">
...
<script src="<?php echo e(asset('vendor/itqan-guest-map-leaflet/leaflet.js')); ?>?v=1.9.4"></script>
<script src="<?php echo e(asset('assets/itqan-external-guest-map/guest-map.js')); ?>?v=itqan-ext-map-2"></script>
</body>
</html>
