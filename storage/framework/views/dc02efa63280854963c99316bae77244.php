...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('assets/css/admin.css')); ?>?v=admin-security-social-inline-1">
</head>
<body>
  ...
  <script src="<?php echo e(asset('assets/js/admin.js')); ?>?v=admin-security-social-inline-1"></script>
</body>
</html>
