...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['type' => 'generic', 'image' => null, 'alt' => '']));
...
foreach (array_filter((['type' => 'generic', 'image' => null, 'alt' => '']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<span <?php echo e($attributes->class('tool-logo')); ?> <?php if(!$image): ?> aria-hidden="true" <?php endif; ?>>
    <?php if($image): ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/ITQANConsulting/resources/views/components/starpmaminul/portfolio/tool-logo.blade.php ENDPATH**/ ?>