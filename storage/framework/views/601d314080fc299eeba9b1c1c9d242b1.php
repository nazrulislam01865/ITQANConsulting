...
<div class="grid three">
  ...
  <a class="card" href="<?php echo e(route('admin.map.dashboard')); ?>">
    <div class="metric"><?php echo e($guestMapPlaces); ?></div>
    <h3>Resort Guest Map</h3>
    <p><?php echo e($guestMapPaths); ?> saved curved path connection(s). Manage places, vertices, pathways, and the illustrated map.</p>
  </a>
</div>
